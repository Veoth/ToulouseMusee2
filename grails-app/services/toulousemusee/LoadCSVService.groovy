...
class LoadCSVService {
    ...
    def loadCSV() {
        ...
        musee2 = new Musee(nom: "CMAV - CENTRE MERIDIONAL DE L'ARCHITECTURE DE LA VILLE", horairesOuverture: "Ouvert du mardi au samedi de 13h à 19hfermé les dimanches, jours fériés et du 1er au 15 août", telephone: "05 61 23 30 49    ", accesBus: "ncv, 2, 10, 12, 14, 38, 78 et 80", accesMetro: "Capitole (A), Jean Jaurès (B)", adresse: adresse2, gestionnaire: gestionnaire2)
        ...
        musee4 = new Musee(nom: "INSTITUT CATHOLIQUE DE TOULOUSE - ESPACE MUSEOGRAPHIQUE BACCRABERE - SALLE TOLOSA", horairesOuverture: "Ouvert le premier vendredi de chaque mois de 18h à 20h.", telephone: "05 61 36 81 12", accesBus: "2, 38", accesMetro: "Carmes (B)", adresse: adresse4, gestionnaire: gestionnaire3)
        ...
        musee7 = new Musee(nom: "MUSEE DES AUGUSTINS - MUSEE DES BEAUX ARTS DE TOULOUSE", horairesOuverture: "Tous les jours : 10h - 18h /  nocturne le mercredi jusqu'à 21h.", telephone: "05 61 22 21 82", accesBus: "ncv, 2, 10, 14, 38, 78, 80", accesMetro: "Esquirol (A) ou Carmes (B)", adresse: adresse7, gestionnaire: gestionnaire1)
        musee8 = new Musee(nom: "MUSEE DES COMPAGNONS", horairesOuverture: "Le Mercredi et le 1er dimanche de chaque mois de 14h à 17h", telephone: "05 62 47 41 77", accesBus: "2, 10, 12, 14, 38, 78, 80", accesMetro: "Esquirol, Capitole (A)", adresse: adresse8, gestionnaire: gestionnaire2)
        ...
        musee10 = new Musee(nom: "MUSEE DU VIEUX TOULOUSE", horairesOuverture: "Ouvert tous les jours du 2 mai au 31 octobre de 14h00 à 18h00.Fermé le dimanche et jours fériés.", telephone: "05 62 27 11 50", accesBus: "2, 10, 12, 14, 38, 78, 80", accesMetro: "Esquirol, Capitole (A)", adresse: adresse10, gestionnaire: gestionnaire2)
